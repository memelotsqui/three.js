...
class GLTFTextureBasisUExtension {
    ...
    loadTexture(textureIndex) {
        ...
        if (textureDef == undefined) {
            console.warn(json.textures.length);
            console.warn(textureIndex);
            console.warn(json.textures[textureIndex].extensions);
        }
...
CustomCubicSplineInterpolant.prototype.interpolate_ = function(i1, t0, t, t1) {
    ...
    for (let i = 0; i !== stride; i++) {
        ...
        // const p0 = values[offset0 + i + stride]; // splineVertex_k
        //const m0 = tangents[offset0 + i + stride2].y * td; // outTangent_k * (t_k+1 - t_k)
        // const p1 = values[offset1 + i + stride]; // splineVertex_k+1
        //const m1 = tangents[offset1 + i].x * td; // inTangent_k+1 * (t_k+1 - t_k)
...
class GLTFParser {
        ...
        if (!dependency) {
            ...
            switch (type) {
                ...
                case 'cubeTexture':
                    ...
                    // dependency = this.loadCubeTexture(index)
                    break;
                default:
    ...
    loadNode(nodeIndex) {
        ...
        //custom remove unique name in nodes
